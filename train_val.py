...
# from yolo.resnet18 import Resnet18
...
def main():
    ...
    parser.add_argument('--weights', default = 'yolo_v2.ckpt', type = str)  # darknet-19.ckpt #yolo_v2.ckpt #Final_weights_CIFAR10_darknet_32bit_model_v2.ckpt
